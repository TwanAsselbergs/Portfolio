          ...
          <div>
            ...
            <div className="flex gap-5">
              <a
                ...
                <FaLinkedin className="w-[60px] rounded-lg cursor-pointer h-[60px] p-4 text-gray-700 bg-[#24272b] shadow-lg hover:shadow-xl duration-500 hover:bg-[#2e3136]" />
              </a>
              <a
                href="https://github.com/TwanAsselbergs"
                target="_blank"
                rel="noopener noreferrer">
                <FaGithub className="w-[60px] rounded-lg cursor-pointer h-[60px] p-4 text-gray-700 bg-[#24272b] shadow-lg hover:shadow-xl duration-500 hover:bg-[#2e3136]" />
              </a>
            </div>
          </div>
        </div>
